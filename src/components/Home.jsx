  ...
  return (
    ...
    >
      <div className="max-w-full-lg mx-auto flex flex-col items-center  justify-center h-full px-4 md:flex-row">
        <div className=" flex flex-col items-center  justify-center h-full px-4 md:flex-row pt-10 sm:pt-20 lg:pt-32 pb-14 ">
        <div className=" flex flex-col justify-center h-1/2">
          <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-white">
